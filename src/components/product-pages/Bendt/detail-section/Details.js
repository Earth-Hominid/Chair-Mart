...
const Details = () => {
  ...
  return (
    <>
      <ProductDetailsContainer>
        <ProductTitle>{chairProducts[9].name}</ProductTitle>
        <ProductPrice>{chairProducts[9].amount}</ProductPrice>
        <ProductSubtitle>Color</ProductSubtitle>
        <ColorContainer>
          <ColorButton> {chairProducts[9].color}</ColorButton>
          <SecondaryColorButton>
            {chairProducts[9].colorTwo}
          </SecondaryColorButton>
        </ColorContainer>
        ...
        <ButtonContainer>
          <AddToBagButton
            onClick={() => addToBag(chairProducts[9], `${quantity}`)}
          >
            Add to bag
          </AddToBagButton>
