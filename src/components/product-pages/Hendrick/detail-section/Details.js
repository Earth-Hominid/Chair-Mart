...
const Details = () => {
  ...
  return (
    <>
      <ProductDetailsContainer>
        <ProductTitle>{chairProducts[2].name}</ProductTitle>
        <ProductPrice>{chairProducts[2].amount}</ProductPrice>
        ...
        <ButtonContainer>
          <AddToBagButton
            onClick={() => addToBag(chairProducts[2], `${quantity}`)}
          >
            Add to bag
          </AddToBagButton>
