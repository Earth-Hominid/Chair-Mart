...
const Details = () => {
  ...
  return (
    <>
      <ProductDetailsContainer>
        <ProductTitle>{chairProducts[8].name}</ProductTitle>
        <ProductPrice>{chairProducts[8].amount}</ProductPrice>
        <ProductSubtitle>Color</ProductSubtitle>
        <ColorContainer>
          <ColorButton> {chairProducts[8].color}</ColorButton>
          <SecondaryColorButton>
            {chairProducts[8].colorTwo}
          </SecondaryColorButton>
        </ColorContainer>
        ...
        <ButtonContainer>
          <AddToBagButton
            onClick={() => addToBag(chairProducts[8], `${quantity}`)}
          >
            Add to bag
          </AddToBagButton>
