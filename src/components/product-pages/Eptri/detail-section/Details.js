...
const Details = () => {
  ...
  return (
    <>
      <ProductDetailsContainer>
        <ProductTitle>{chairProducts[3].name}</ProductTitle>
        <ProductPrice>{chairProducts[3].amount}</ProductPrice>
        <ProductSubtitle>Color</ProductSubtitle>
        <ColorContainer>
          <ColorButton> {chairProducts[3].color}</ColorButton>
          <SecondaryColorButton>
            {chairProducts[3].colorTwo}
          </SecondaryColorButton>
        </ColorContainer>
        ...
        <ButtonContainer>
          <AddToBagButton
            onClick={() => addToBag(chairProducts[3], `${quantity}`)}
          >
            Add to bag
          </AddToBagButton>
