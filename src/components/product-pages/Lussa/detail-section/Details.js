...
const Details = () => {
  ...
  return (
    <>
      <ProductDetailsContainer>
        <ProductTitle>{chairProducts[6].name}</ProductTitle>
        <ProductPrice>{chairProducts[6].amount}</ProductPrice>
        <ProductSubtitle>Color</ProductSubtitle>
        <ColorContainer>
          <ColorButton> {chairProducts[6].color}</ColorButton>
          <SecondaryColorButton>
            {chairProducts[6].colorTwo}
          </SecondaryColorButton>
        </ColorContainer>
        ...
        <ButtonContainer>
          <AddToBagButton
            onClick={() => addToBag(chairProducts[6], `${quantity}`)}
          >
            Add to bag
          </AddToBagButton>
