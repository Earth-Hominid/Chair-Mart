...
const Details = () => {
  ...
  return (
    <>
      <ProductDetailsContainer>
        <ProductTitle>{chairProducts[4].name}</ProductTitle>
        <ProductPrice>{chairProducts[4].amount}</ProductPrice>
        <ProductSubtitle>Color</ProductSubtitle>
        <ColorContainer>
          <ColorButton> {chairProducts[4].color}</ColorButton>
          <SecondaryColorButton>
            {chairProducts[4].colorTwo}
          </SecondaryColorButton>
        </ColorContainer>
        ...
        <ButtonContainer>
          <AddToBagButton
            onClick={() => addToBag(chairProducts[4], `${quantity}`)}
          >
            Add to bag
          </AddToBagButton>
